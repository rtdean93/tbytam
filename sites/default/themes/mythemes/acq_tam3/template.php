 ...
 */
function acq_tam3_preprocess_html(&$vars) {
  $vars['classes_array'][] = 'theme-markup-2';
  $vars['classes_array'][] = _acq_tam3_get_layout();
}

/**
 * Implements hook_html_head_alter().
 */
function acq_tam3_html_head_alter(&$head_elements) {
...
function acq_tam3_preprocess_page(&$variables) {
  ...
  $layoutClass = _acq_tam3_get_layout();
 ...
 */
function acq_tam3_preprocess_block(&$vars) {
 ...
 */
function _acq_tam3_variable_get($key, $default) {
  global $theme;
 ...
 */
function _acq_tam3_get_layout() {
  $layout_patterns = _acq_tam3_variable_get('layout', array('<global>' => 'body-layout-fixed-abc'));
 ...
 */
function acq_tam3_node_view_alter(&$build) {
...
function acq_tam3_preprocess_forum_topic_list(&$vars) {
 ...
 */
function acq_tam3_preprocess_media_gallery_license(&$vars) {
